...
const EXPECTED_MODELS = {
  ...
  PROFESSOR_AI_FALLBACK: 'google/gemini-2.0-flash',
...
Deno.test("MODELS.PROFESSOR_AI_FALLBACK is correctly defined", () => {
  ...
  assertEquals(EXPECTED_MODELS.PROFESSOR_AI_FALLBACK, 'google/gemini-2.0-flash');
});
...
Deno.test("Request with fallbacks is correctly structured", () => {
  ...
  assertEquals(requestBody.models[1], 'google/gemini-2.0-flash');
});
