...
Deno.test({
  name: "lecture-visuals storage bucket exists",
  ...
  async fn() {
    ...
    const lectureBucket = data.find(b => b.name === 'lecture-visuals');
    assertExists(lectureBucket, 'lecture-visuals bucket should exist');
  }
});
