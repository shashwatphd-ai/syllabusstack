-- Migration: Fix recommendations, pipeline issues, and unified skills system
-- Combines both migrations for complete setup

-- ================================================================
-- PART 1: Fix Recommendations & Pipeline Issues
-- ================================================================

-- Fix recommendations type constraint
...
-- Soft delete for recommendations
ALTER TABLE recommendations
...
-- Recommendation-Course Links table
...
-- Auto-complete Recommendations Trigger Function
...
-- Add Verified Skill from Course
...
-- ================================================================
-- VIEW: Recommendations with Links
-- ================================================================
...
COMMENT ON TABLE verified_skills IS 'Skills verified through course assessments, micro-checks, or certifications.';
COMMENT ON TABLE recommendation_course_links IS 'Links career recommendations to actual courses for auto-completion tracking.';
COMMENT ON TABLE discovered_careers IS 'Stores AI-discovered career suggestions so users can review them later without re-running discovery.';
COMMENT ON COLUMN recommendations.type IS 'Type of recommendation: course, certification, project, experience, skill, action, reading, networking, or portfolio';
COMMENT ON FUNCTION get_user_skill_profile(UUID) IS 'Returns unified view of all user skills from verified and self-reported sources.';
COMMENT ON VIEW recommendations_with_links IS 'Combines recommendations with their linked courses and enrollment progress.';